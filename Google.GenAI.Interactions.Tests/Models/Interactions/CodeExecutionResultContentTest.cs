...
public class CodeExecutionResultContentTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new CodeExecutionResultContent
        {
            CallID = "call_id",
            Result = "result",
            IsError = true,
    ...
    {
        var model = new CodeExecutionResultContent { CallID = "call_id", Result = "result" };
    ...
    public void CopyConstructor_Works()
    {
        ...
        CodeExecutionResultContent copied = new(model);
