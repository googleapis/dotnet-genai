...
public class DocumentContentTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        ...
        ApiEnum<string, DocumentContentMimeType> expectedMimeType =
            DocumentContentMimeType.ApplicationPdf;
    ...
    public void CopyConstructor_Works()
    {
        ...
        DocumentContent copied = new(model);

        Assert.Equal(model, copied);
    }
}

public class DocumentContentMimeTypeTest : TestBase
{
    [Theory]
    [InlineData(DocumentContentMimeType.ApplicationPdf)]
    public void Validation_Works(DocumentContentMimeType rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, DocumentContentMimeType> value = rawValue;
        value.Validate();
    }
    ...
    {
        var value = JsonSerializer.Deserialize<ApiEnum<string, DocumentContentMimeType>>(
    ...
    [Theory]
    [InlineData(DocumentContentMimeType.ApplicationPdf)]
    public void SerializationRoundtrip_Works(DocumentContentMimeType rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, DocumentContentMimeType> value = rawValue;

        string json = JsonSerializer.Serialize(value, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<ApiEnum<string, DocumentContentMimeType>>(
            json,
            ModelBase.SerializerOptions
        );
