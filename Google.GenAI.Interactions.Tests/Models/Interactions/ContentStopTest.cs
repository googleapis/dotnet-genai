...
public class ContentStopTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new ContentStop { Index = 0, EventID = "event_id" };

        JsonElement expectedEventType = JsonSerializer.SerializeToElement("content.stop");
        int expectedIndex = 0;
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<ContentStop>(
            json,
    ...
    {
        var model = new ContentStop { Index = 0 };
