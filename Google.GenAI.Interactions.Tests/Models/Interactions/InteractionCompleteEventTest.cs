...
public class InteractionCompleteEventTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new InteractionCompleteEvent
        {
            Interaction = new()
            {
        ...
        JsonElement expectedEventType = JsonSerializer.SerializeToElement("interaction.complete");
    ...
    public void CopyConstructor_Works()
    {
        ...
        InteractionCompleteEvent copied = new(model);
