...
public class FileSearchCallContentTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new FileSearchCallContent { ID = "id", Signature = "U3RhaW5sZXNzIHJvY2tz" };
    ...
    {
        var model = new FileSearchCallContent { ID = "id" };
    ...
    {
        var model = new FileSearchCallContent
        {
            ID = "id",
    ...
    public void CopyConstructor_Works()
    {
        ...
        FileSearchCallContent copied = new(model);
