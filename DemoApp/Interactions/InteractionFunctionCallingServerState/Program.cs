...
{
    Input = InteractionsInput.CreateStr("Schedule a meeting for 2025-11-01 at 10 am with Peter and Amir about the Next Gen API"),
...
if (functionCallId != null)
{
    ...
    CreateModelInteraction followUpParams = new()
    {
        ...
        Input = InteractionsInput.CreateArrayOfStep(new List<Step> { Step.CreateFunctionResult(functionResult) })
    };
