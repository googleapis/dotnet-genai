...
TextContent textContent = new() { Text = "What is shown in this image?" };
...
List<Content> contents = new List<Content> { Content.CreateText(textContent), Content.CreateImage(imageContent) };
