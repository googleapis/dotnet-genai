...
[assembly: System.Runtime.CompilerServices.InternalsVisibleTo("Google.GenAI.Tests")]
[assembly: System.Runtime.CompilerServices.InternalsVisibleTo("Google.GenAI.Netstandard2_0.Tests")]
[assembly: System.Runtime.CompilerServices.InternalsVisibleTo("Google.GenAI.Interactions.Tests")]
...
namespace Google.GenAI
{
  ...
  public abstract class ApiClient : IDisposable, IAsyncDisposable
  {
    ...
    public Google.GenAI.Interactions.Core.ClientOptions InteractionsClientOptions { get; protected set; }
        ...
        Google.GenAI.Types.ClientOptions? clientOptions = null)
    {
      ...
      if (customHttpOptions != null)
      {
       ...
       this.InteractionsClientOptions = new()
       {
         ApiKey = this.ApiKey,
         HttpClient = (HttpClient) this.HttpClient,
         Timeout = this.HttpOptions.Timeout != null ? TimeSpan.FromMilliseconds(this.HttpOptions.Timeout.Value) : null,
         // these will always be set by `GetDefaultHttpOptions`
         BaseUrl = this.HttpOptions.BaseUrl!,
         ApiVersion = this.HttpOptions.ApiVersion!,
       };

       if (this.VertexAI && this.Project != null && this.Location != null)
       {
         this.InteractionsClientOptions = this.InteractionsClientOptions with
         {
           VertexInfo = new()
           {
