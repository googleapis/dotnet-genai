...
namespace Google.GenAI.Types {
  ...
  public record ReplicatedVoiceConfig {
    ...
    /// <summary>
    /// Recorded consent verifying ownership of the voice. This represents 16-bit signed
    /// little-endian wav data, with a 24kHz sampling rate.
    /// </summary>
    [JsonPropertyName("consentAudio")]
    [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)]
    public byte[]
        ? ConsentAudio {
            get; set;
