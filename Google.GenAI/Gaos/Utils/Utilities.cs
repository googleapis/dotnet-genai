...
namespace Google.GenAI.Gaos.Utils
{
    ...
    public class Utilities
    {
        ...
        public static Newtonsoft.Json.Linq.JToken LoadRawToken(JsonReader reader)
        {
            var textReader = reader as JsonTextReader;
            if (textReader == null || textReader.DateParseHandling == DateParseHandling.None)
            {
                return Newtonsoft.Json.Linq.JToken.Load(reader);
            }
            var previous = textReader.DateParseHandling;
            ...
            {
                textReader.DateParseHandling = previous;
            }
        }
        ...
        public static bool IsModelNamespace(string ns)
        {
            var modelNamespaces = new[] {
                "Google.GenAI.Gaos.Models.Requests",
                "Google.GenAI.Gaos.Models.Agents",
                "Google.GenAI.Gaos.Models.Interactions",
                "Google.GenAI.Gaos.Models.Components",
                "Google.GenAI.Gaos.Models.Environments",
                "Google.GenAI.Gaos.Models.Errors",
        ...
        public static bool IsDate(object? obj) =>
            obj != null && (obj.GetType() == typeof(DateTime));
