...
namespace Google.GenAI.Gaos
{
    ...
    public class GenAI: IGenAI
    {
        ...
        /// <param name="apiRevision">API revision header to send with Google GenAI API requests.</param>
        ...
        public class SDKBuilder
        {
            ...
            /// <summary>
            /// Sets the ApiRevision global parameter for the SDK.
            /// </summary>
            public SDKBuilder WithApiRevision(string apiRevision)
            {
                _sdkConfig.ApiRevision = apiRevision;
                return this;
            }
            /// <summary>
