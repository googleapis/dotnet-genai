...
namespace Google.GenAI.Gaos.Models.Agents
{
    ...
    {
        private AgentToolType(string value) { Value = value; }

        public string Value { get; private set; }

        public static AgentToolType CodeExecution { get { return new AgentToolType("code_execution"); } }

        public static AgentToolType GoogleSearch { get { return new AgentToolType("google_search"); } }

        public static AgentToolType UrlContext { get { return new AgentToolType("url_context"); } }

        public static AgentToolType McpServer { get { return new AgentToolType("mcp_server"); } }

        public override string ToString() { return Value; }
        public static implicit operator String(AgentToolType v) { return v.Value; }
        public static AgentToolType FromString(string v) {
            switch(v) {
                ...
                default: throw new ArgumentException("Invalid value for AgentToolType");
            }
        }
