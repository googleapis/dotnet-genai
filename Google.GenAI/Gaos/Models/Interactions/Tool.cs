...
namespace Google.GenAI.Gaos.Models.Interactions
{
    ...
    {
        private ToolType(string value) { Value = value; }

        public string Value { get; private set; }

        public static ToolType Function { get { return new ToolType("function"); } }

        public static ToolType CodeExecution { get { return new ToolType("code_execution"); } }

        public static ToolType UrlContext { get { return new ToolType("url_context"); } }

        public static ToolType ComputerUse { get { return new ToolType("computer_use"); } }

        public static ToolType McpServer { get { return new ToolType("mcp_server"); } }

        public static ToolType GoogleSearch { get { return new ToolType("google_search"); } }

        public static ToolType FileSearch { get { return new ToolType("file_search"); } }

        public static ToolType GoogleMaps { get { return new ToolType("google_maps"); } }

        public static ToolType Retrieval { get { return new ToolType("retrieval"); } }

        public override string ToString() { return Value; }
        public static implicit operator String(ToolType v) { return v.Value; }
        public static ToolType FromString(string v) {
            switch(v) {
                ...
                case "mcp_server": return McpServer;
                case "google_search": return GoogleSearch;
                case "file_search": return FileSearch;
                case "google_maps": return GoogleMaps;
                case "retrieval": return Retrieval;
                default: throw new ArgumentException("Invalid value for ToolType");
            }
        }
