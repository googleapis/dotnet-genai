    ...
    public class Processing : Google.GenAI.Gaos.Utils.IOpenUnion
    {
        ...
        public class ProcessingConverter : JsonConverter
        {
            ...
            public override object? ReadJson(JsonReader reader, System.Type objectType, object? existingValue, JsonSerializer serializer)
            {
                ...
                try
                {
                    return new Processing(ProcessingType.MediaProcessing) {
                        MediaProcessing = ResponseBodyDeserializer.DeserializeUndiscriminatedUnionMember<MediaProcessing>(json)
                    };
                }
                catch (ResponseBodyDeserializer.MissingMemberException)
                {
                    fallbackCandidates.Add((typeof(MediaProcessing), new Processing(ProcessingType.MediaProcessing), "MediaProcessing"));
                }
                ...
                try
                {
                    return new Processing(ProcessingType.ProcessingEnum) {
                        ProcessingEnum = ResponseBodyDeserializer.DeserializeUndiscriminatedUnionMember<ProcessingEnum>(json)
                    };
                }
                catch (ResponseBodyDeserializer.MissingMemberException)
                {
                    fallbackCandidates.Add((typeof(ProcessingEnum), new Processing(ProcessingType.ProcessingEnum), "ProcessingEnum"));
                }
                catch (ResponseBodyDeserializer.DeserializationException)
                {
                    // try next option
