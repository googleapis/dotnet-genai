...
namespace Google.GenAI.Gaos.Models.Interactions
{
    ...
    public class StepDeltaDataType
    {
        ...
        public static StepDeltaDataType ProcessingCall
        {
            get {
                return new StepDeltaDataType("processing_call");
            }
        }

        public static StepDeltaDataType ProcessingResult
        {
            get {
                return new StepDeltaDataType("processing_result");
            }
        }
    ...
    public class StepDeltaData : Google.GenAI.Gaos.Utils.IOpenUnion
    {
        ...
        [SpeakeasyMetadata("form:explode=true")]
        public ProcessingCallDelta? ProcessingCallDelta { get; set; }

        [SpeakeasyMetadata("form:explode=true")]
        public ProcessingResultDelta? ProcessingResultDelta { get; set; }
        ...
        public static StepDeltaData CreateProcessingCall(ProcessingCallDelta processingCall)
        {
            StepDeltaDataType typ = StepDeltaDataType.ProcessingCall;
            StepDeltaData res = new StepDeltaData(typ);
            res.ProcessingCallDelta = processingCall;
            return res;
        }

        public static StepDeltaData CreateProcessingResult(ProcessingResultDelta processingResult)
        {
            StepDeltaDataType typ = StepDeltaDataType.ProcessingResult;
            StepDeltaData res = new StepDeltaData(typ);
            res.ProcessingResultDelta = processingResult;
            return res;
        }
        ...
        public class StepDeltaDataConverter : JsonConverter
        {
            ...
            public override object? ReadJson(JsonReader reader, System.Type objectType, object? existingValue, JsonSerializer serializer)
            {
                ...
                if (discriminator == StepDeltaDataType.ProcessingCall.ToString())
                {
                    ProcessingCallDelta processingCallDelta;
                    try
                    {
                        processingCallDelta = ResponseBodyDeserializer.DeserializeNotNull<ProcessingCallDelta>(jo.ToString());
                    }
                    catch (Exception)
                    {
                        if (!ResponseBodyDeserializer.TryConstructUnvalidated<ProcessingCallDelta>(jo.ToString(), out processingCallDelta))
                        {
                            throw;
                        }
                    }
                    return CreateProcessingCall(processingCallDelta);
                }
                if (discriminator == StepDeltaDataType.ProcessingResult.ToString())
                {
                    ProcessingResultDelta processingResultDelta;
                    try
                    {
                        processingResultDelta = ResponseBodyDeserializer.DeserializeNotNull<ProcessingResultDelta>(jo.ToString());
                    }
                    catch (Exception)
                    {
                        if (!ResponseBodyDeserializer.TryConstructUnvalidated<ProcessingResultDelta>(jo.ToString(), out processingResultDelta))
                        {
                            throw;
                        }
                    }
                    return CreateProcessingResult(processingResultDelta);
                }
            ...
            public override void WriteJson(JsonWriter writer, object? value, JsonSerializer serializer)
            {
                ...
                if (res.ProcessingCallDelta != null)
                {
                    writer.WriteRawValue(Utilities.SerializeJSON(res.ProcessingCallDelta));
                    return;
                }

                if (res.ProcessingResultDelta != null)
                {
                    writer.WriteRawValue(Utilities.SerializeJSON(res.ProcessingResultDelta));
                    return;
                }
