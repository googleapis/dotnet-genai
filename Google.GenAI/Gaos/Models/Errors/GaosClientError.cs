...
namespace Google.GenAI.Gaos.Models.Errors
{
    ...
    /// <summary>
    /// Carrier base bridging gaos 4xx errors onto the native
    /// <see cref="Google.GenAI.ClientError"/> hierarchy while preserving the gaos
    /// Message/Request/Response/Body surface.
    /// </summary>
    public abstract class GaosClientError : Google.GenAI.ClientError
    {
        /// <summary>
        /// Error Message
        /// </summary>
